...
A local-first Chrome/Edge extension that remembers which email account you used on each website. It stores no passwords and sends no data anywhere.
...
- Local data does not sync across devices. Export/import provides a manual backup path.
